...
% Watermark logo UNY kuning di tengah halaman (lembar persetujuan & pengesahan)
\newcommand{\logowatermark}{%
    \begin{tikzpicture}[remember picture, overlay]
        \node at (current page.center) {\includegraphics[width=12cm]{gambar/logo-uny-kuning.png}};
    \end{tikzpicture}%
}
